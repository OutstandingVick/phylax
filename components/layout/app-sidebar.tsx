...
import { AlertTriangle, BarChart3, BookOpen, CreditCard, FileCheck2, FileText, Gauge, RotateCw, Settings, Wallet } from "lucide-react";
...
const items = [
  ...
  { href: "/dashboard/evidence", label: "Proof & Evidence", icon: FileCheck2 },
